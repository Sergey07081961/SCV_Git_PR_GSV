...
1. Создать аккаунт на GitHub на сайте https://github.com
2. Создать локальный репозиторий согласно данной инструкции
3. Создать удаленный репозторий на сайте https://github.com  
Крме создания удаленного репозитария потркбуется авторизация.
4. Связать удаленный  репозиторий с локальным.
5. Добавить удаленный репозиторий к проекту:

Для добавления удаленного репозитория к проекту используем команды:  
```
git remote add origin <url - адес репозитория в сети>
```
```
...
Для выгрузки изменений из локального репозитория используем команду `git push`  
6. Для участия в выбранно проекте не обходимо создать в своем аккаунте копию репозитория при помощи команды `fok`
Скопировать адрес репозитория.
создать или открыть (перйти при пмощи командв `cd`) в папку неявляющейся репозиторим и при помощи команды git clone <url - алрес репозитория в сети> произвести загрузку на локальный компьютер.
Все изменния с копией репозитория производятся в новой ветке.  Создать новую ветку.  
Внести изменения, зафиксировать изменния  кмандой `git commit`и выгрузить в удаленный репозиторий командой `git push`.  
Отправить автору проекта для ознакомления с измененими через `pull request`
